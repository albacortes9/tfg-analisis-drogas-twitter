...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`tweet` (
    ...
    `media` TINYINT NULL,
    PRIMARY KEY (`id`),
    FOREIGN KEY (`author_id`) REFERENCES `twitter_analysis`.`user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`tweet_metrics` (
    ...
    `like_count` INT NULL,
    `quote_count` INT NULL PRIMARY KEY (`tweet_id`),
    FOREIGN KEY (`tweet_id`) REFERENCES `twitter_analysis`.`tweet` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`drug_keyword` (
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY (`drug_id`) REFERENCES `twitter_analysis`.`drug` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`tweet_keyword` (
    ...
    FOREIGN KEY (`tweet_id`) REFERENCES `twitter_analysis`.`tweet` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (`keyword_id`) REFERENCES `twitter_analysis`.`drug_keyword` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`metamap` (
    ...
    `annotation3` VARCHAR(10) NULL,
    PRIMARY KEY (`cui`),
    FOREIGN KEY (`tui`) REFERENCES `twitter_analysis`.`semantic_type` (`tui`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`tweet_metamap` (
    ...
    FOREIGN KEY (`tweet_id`) REFERENCES `twitter_analysis`.`tweet` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (`cui`) REFERENCES `twitter_analysis`.`metamap` (`cui`) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (`tui`) REFERENCES `twitter_analysis`.`semantic_type` (`tui`)
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `twitter_analysis`.`tweet_slang` (
    ...
    FOREIGN KEY (`tweet_id`) REFERENCES `twitter_analysis`.`tweet` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (`slang_id`) REFERENCES `twitter_analysis`.`slang` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
